# Oliver Henry on X: "How my OpenClaw agent, Larry, got millions of TikTok views in one week. (Full step-by-step guide)" / X

- Source: x
- URL: https://x.com/oliverhenry/status/2022011925903667547
- IngestedAt: 2026-02-14T09:32:31Z
- Tags: #source:x #type:tweet #x #twitter #lang:en #ai #agent #security #engineering #product #growth #startup #social #openclaw
- Status: ok

## 备注

from Telegram message_id:2032

## 内容

Title: Oliver Henry on X: "How my OpenClaw agent, Larry, got millions of TikTok views in one week. (Full step-by-step guide)" / X

URL Source: https://x.com/oliverhenry/status/2022011925903667547

Published Time: Sat, 14 Feb 2026 09:27:53 GMT
...
Within a week, Larry earnt me over $4000, thanks to a meme coin that got spun up for him and a

. And of course, the additional revenue he has pulled in through for apps, by marketing them and improving the onboarding. Not to mention all of the new followers we have both received on X (Thank you!)
...
*   Access to post to TikTok via

, i chose this because it has super easy docs for Larry to understand, and the API is included in the price.(The link is also my affiliate link, i'd appreciate you using it since we're sharing the sauce) 
...
- this is the brain. It gives your AI agent identity, memory, and tool access. Install it, set it up, and you have an agent that lives on your machine.

3.

- this is how your agent posts to TikTok. It has an API that lets you upload slideshows as drafts. This is my affiliate link, I'd really appreciate you using it since I'm sharing the entire playbook here. It directly supports us continuing to share what we learn.
...
Larry posts everything through

a social media scheduling tool with an API. I chose

because it has API included in the plan, it's got incredible documentation for the AI to understand and it's relatively cheap. For Larry, all I had to do was feed him the API docs pages.
...
2. Larry uploads everything to TikTok as a draft via
...
Then we set up the schedule. Each post gets its own brief. Larry can pre-generate everything overnight using

which is 50% cheaper than real-time generation. By morning, an entire day's content is ready to go.

Larry also has access to my RevenueCat analytics through the

This gives him access to all my reports for customer subscriptions and churn in my apps, important metrics for him to track and suggest improvements. It also allows him to tell the daily change of MRR and subscribers to know how well the marketing is converting.

This is one of ONLY TWO skills Larry uses from clawhub. It was made by

- RevenueCat's CEO so I trust it. The other is bird which is made by

- the creator of OpenClaw to give Larry access to browse X (I still use

for Larry to post for X)
...
3. Get an image generation keykey. As I said, I use OpenAI. Sign up at

. You'll use gpt-image-1.5 for image generation. Expect to spend about $0.50 per slideshow, or $0.25 if you use the Batch API.

4. Sign up for

.This is the tool that connects your agent to TikTok. It has an API that lets you upload slideshows as drafts. **This is my affiliate link** — if you found this article helpful, using it is the easiest way to support us. We're sharing our entire playbook here and this helps feed Larry tokens.
...
I'm building Snugly and Liply in public, I also share insights on how to increase your conversions using RevenueCat. Follow me

on X.

Larry has his own X account,
...
so we can keep sharing what we learn.
